<?php
/**
 * Newspack Network Node plugin administration screen handling.
 *
 * @package Newspack
 */
 ...
 */
class Admin {
	const PAGE_SLUG = 'newspack-network-node';
	...
	public static function add_admin_menu() {
		$page_suffix = add_menu_page(
			__( 'Newspack Node', 'newspack-network-node' ),
			__( 'Newspack Node', 'newspack-network-node' ),
			'manage_options',
			self::PAGE_SLUG,
	...
	/**
	 * Adds a child admin page to the main Newspack Network Node admin page
	 *
